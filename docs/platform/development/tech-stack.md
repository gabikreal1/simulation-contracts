...
| Smart Contract Framework | Anchor 0.30.1 | Type-safe development, account validation |
| Contract Language | Rust | On-chain program logic |
...
|-----------|-----------|---------|
| Rust Toolchain | rustup (stable + nightly) | Latest stable |
| Solana CLI | Solana Tool Suite | v1.18+ |
| Anchor CLI | Anchor | v0.30.1 |
| Node.js | Node | v18+ |
